...
# Dalei Jiang 
# Two functions of modification on nn.Conv2d and nn.Linear, which considers the limitation of the hardware and make bit limitations
# The cost is that, it takes more in-memory, and loss accuracy owing to the limitation on bits.
# Many of the param are used for hardware settings.
...
class QConv2d(nn.Conv2d):
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        self.inference = inference              # Bit constraint
        self.onoffratio = onoffratio            # The on-off ratio of the devices
        self.cellBit = cellBit                  # Bit constraint
